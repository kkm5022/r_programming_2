...
# data.frame은 칼럼을 붙여준다 
# substr("김민규",1,2) => "김민" 첫번째부터 두번쨰까지 뽑는다
# sapply 
...
#E_level_kr <- (ifelse(BFI_score$E_score <= 4, "하", ifelse(BFI_score$E_score <= 6, "중하", ifelse(BFI_score$E_score <= 8, "중상", "상")))) 
