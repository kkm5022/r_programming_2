...
quiz0409 <- read.csv("../data/sok.csv",
...
quiz0409$Q2 <- factor(quiz0409$Q2, 
                      levels = c("가", "나", "다", "라", "무응답"), 
                      labels = c("28 vs 46", "28 vs 71", "28 vs 25", "25 vs 54", "불참"))
...
rownames(tbl.q1.a)[2] <- "계"
kable(tbl.q1.a)
print(chisq.test(tbl.q1[, -c(4:5,6)], 
...
tbl.q1.a.p <- prop.table(tbl.q1.a[2, -(5:6)])
...
rownames(tbl.q2.a)[2] <- "계"
kable(tbl.q2.a)
print(chisq.test(tbl.q2[, 1:4], 
                  simulate.p.value = TRUE))
```
...
tbl.q2.a.p <- prop.table(tbl.q2.a[2, -(5:6)])
...
rownames(tbl.q3.a) <- c("Black(구체적 질문 먼저)", "계") 
...
rownames(tbl.q4.a) <- c("Black(추상적 질문 먼저)", "계")
