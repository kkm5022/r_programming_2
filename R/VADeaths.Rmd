...
Place <- sapply(strsplit(as.character(df$Var2), split = " "), function(x) x[1])
Gender <- sapply(strsplit(as.character(df$Var2), split = " "), function(x) x[2])
data.frame(Age = ordered(df$Var1), 
           Place = factor(Place), 
